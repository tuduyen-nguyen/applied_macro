[output_table,~,T] = call_dbnomics('OECD/QNA/DEU.B1_GE.CQRSA.Q','OECD/QNA/DEU.P31DC.CQRSA.Q','OECD/QNA/DEU.P51.CQRSA.Q','OECD/QNA/DEU.B1_GE.DNBSA.Q','Eurostat/LFSQ_EWHAIS/Q.TOTAL.SAL.TOTAL.Y_GE15.T.HR.DE','OECD/KEI/IR3TIB01.DEU.ST.Q', 'Eurostat/LFSQ_URGACOB/Q.TOTAL.T.Y15-74.PC.DE');
...
% Filter data from 2005 onwards (start of quarterly data)
start_year = 2005;
